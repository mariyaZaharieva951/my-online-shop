...
const Category = () => {
    return (
        <div className="boxSmall w-full mx-auto flex flex-col justify-between pt-[45px]">
            ...
            <ul className="flex flex-col lg:flex-row justify-between font-roboto items-center pt-[60px]">
